    ...
    <section className="relative mx-auto w-full max-w-6xl px-5 pt-20 pb-14 sm:pt-28">
      ...
      >
        ...
        <div className="grid gap-0 lg:grid-cols-[1.5fr_1fr]">
          {/* Log */}
          <div className="border-b border-line p-5 font-mono text-[12.5px] leading-7 lg:border-b-0 lg:border-r">
            {TERMINAL_LINES.map((line, i) => (
              ...
              >
                ...
                <span className={line.ok ? "text-zinc-300" : "text-zinc-500"}>
                  {line.text}
                </span>
              </div>
            ))}
          ...
          <div className="flex flex-col justify-between gap-6 p-5">
            <div className="grid grid-cols-2 gap-x-4 gap-y-5">
              <div>
                ...
                <p className="mono-num mt-1.5 text-2xl font-semibold text-zinc-100">
                  {aiMinutes}h
                  <span className="ml-1.5 text-sm font-normal text-zinc-500 line-through">
                    20h
                  </span>
                </p>
              </div>
            ...
            <div className="flex items-center gap-2 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-3 py-2">
              ...
              <span className="mono-num text-[12px] font-semibold tracking-wide text-emerald-300">
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-3">
          {!revealed && (
            <button
              onClick={onSimulate}
              className="group inline-flex items-center gap-2.5 rounded-xl bg-zinc-100 px-5 py-3 text-[14px] font-semibold text-zinc-950 transition-all hover:bg-white hover:shadow-[0_0_40px_-8px_rgba(244,63,94,0.5)]"
            >
